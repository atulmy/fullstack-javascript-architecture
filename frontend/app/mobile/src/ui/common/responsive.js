...
// Margin and Padding
export const blockMargin = deviceWidth >= breakpointTablet ? (10 * scaleFactor) : 10
export const blockMarginHalf = blockMargin / 2
export const blockPadding = deviceWidth >= breakpointTablet ? (10 * scaleFactor) : 10
...
export const buttonRadius = deviceWidth >= breakpointTablet ? (40 * scaleFactor) : 40

// Item
export const itemSpacing = deviceWidth >= breakpointTablet ? (20 * scaleFactor) : 20
export const itemRadius = deviceWidth >= breakpointTablet ? (10 * scaleFactor) : 10
export const itemRadiusHalf = itemRadius / 2

// Navigation
export const navigationTopHeight = deviceWidth >= breakpointTablet ? (50 * scaleFactor) : 50
