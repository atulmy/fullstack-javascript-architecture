...
const Terms = () => (
  <Layout>
    <Section>
      ...
      <h3>1. Terms</h3>
      <p>
        By accessing the website at <a href={URL_LANDING}>{URL_LANDING}</a>, you
      ...
      <ol type='a'>
        <li>
          ...
          materials (information or software) on {params.site.name}'s website
        ...
        <li>
          ...
          restrictions and may be terminated by {params.site.name} at any time.
      ...
      <ol type='a'>
        <li>
          The materials on {params.site.name}'s website are provided on an 'as
          is' basis. {params.site.name} makes no warranties, expressed or
        ...
        <li>
          Further, {params.site.name} does not warrant or make any
      ...
      <h3>4. Limitations</h3>
      <p>
        In no event shall {params.site.name} or its suppliers be liable for any
        damages (including, without limitation, damages for loss of data or
        profit, or due to business interruption) arising out of the use or
        inability to use the materials on {params.site.name}'s website, even if{' '}
        {params.site.name} or a {params.site.name} authorized representative has
      ...
      <p>
        The materials appearing on {params.site.name}'s website could include
        technical, typographical, or photographic errors. {params.site.name}{' '}
        does not warrant that any of the materials on its website are accurate,
        complete or current. {params.site.name} may make changes to the
        materials contained on its website at any time without notice. However{' '}
        {params.site.name} does not make any commitment to update the materials.
      </p>
      <h3>6. Links</h3>
      <p>
        {params.site.name} has not reviewed all of the sites linked to its
        ...
        {params.site.name} of the site. Use of any such linked website is at the
        user's own risk.
      </p>
      <h3>7. Modifications</h3>
      <p>
        {params.site.name} may revise these terms of service for its website at
      ...
      <p>
        ...
        with the laws of {params.site.contact.address} and you irrevocably
