...
// App Imports
import { LANDING_URL, CONTACT_ADDRESS } from '../../../setup/config/env'
...
const Terms = () => (
  <Section>
    ...
    <h3>1. Terms</h3>
    <p>By accessing the website at <a href={ LANDING_URL }>{ LANDING_URL }</a>, you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this website are protected by applicable copyright and trademark law.</p>
    <h3>2. Use License</h3>
    <ol type="a">
    ...
    <p>These terms and conditions are governed by and construed in accordance with the laws of { CONTACT_ADDRESS } and you irrevocably submit to the exclusive jurisdiction of the courts in that State or location.</p>
